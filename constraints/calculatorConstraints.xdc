...
##====================================================================
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {Parallel_out_Rx[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[0]}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {Parallel_out_Rx[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[1]}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {Parallel_out_Rx[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[2]}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {Parallel_out_Rx[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[3]}]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {Parallel_out_Rx[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[4]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {Parallel_out_Rx[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[5]}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {Parallel_out_Rx[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[6]}]
##Sch name = JB10 
set_property PACKAGE_PIN C16 [get_ports {Parallel_out_Rx[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {Parallel_out_Rx[7]}]
...
## USB-RS232 Interface
##====================================================================
set_property PACKAGE_PIN B18 [get_ports Serial_in_Rx]						
	set_property IOSTANDARD LVCMOS33 [get_ports Serial_in_Rx]
set_property PACKAGE_PIN A18 [get_ports Serial_out_Tx]						
	set_property IOSTANDARD LVCMOS33 [get_ports Serial_out_Tx]
